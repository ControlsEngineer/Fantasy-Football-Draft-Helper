def Player_selector(data, QBs, RBs, WRs, TEs, Positions_Remaining,league_size):
    ...
    # ## Call the functions 
    QB_Name, QB_Points, QB_Team, QB_Value_Over_Replacement, QB_Replacement_Value = QB_Selector(data,QBs,league_size)
    RB_Name, RB_Points, RB_Team, RB_Value_Over_Replacement, RB_Replacement_Value = RB_Selector(data,RBs,league_size)
    WR_Name, WR_Points, WR_Team, WR_Value_Over_Replacement, WR_Replacement_Value = WR_Selector(data,WRs,league_size)
    TE_Name, TE_Points, TE_Team, TE_Value_Over_Replacement, TE_Replacement_Value = TE_Selector(data,TEs,league_size)
    ...
    return(Player_Name,Player_Position,Player_Points,Player_Team)
